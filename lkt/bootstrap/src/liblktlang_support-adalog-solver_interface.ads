...
generic
   with package Logic_Vars is new Liblktlang_Support.Adalog.Logic_Var (<>);
...
package Liblktlang_Support.Adalog.Solver_Interface is

   use Logic_Vars;

   subtype Logic_Context_Access is Logic_Context_Type_Access;

   package Logic_Context_Vectors is new Liblktlang_Support.Vectors
...
end Liblktlang_Support.Adalog.Solver_Interface;
