...
package Liblktlang_Support.Internal.Descriptor is
   ...
   --  Liblktlang_Support.Generic_API.* packages. Ref-counting operations are
...
end Liblktlang_Support.Internal.Descriptor;
