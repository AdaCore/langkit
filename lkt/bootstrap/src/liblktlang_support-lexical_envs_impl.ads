...
package Liblktlang_Support.Lexical_Envs_Impl is
   ...
   package Entity_Vectors is new Liblktlang_Support.Vectors
   ...
   package Referenced_Envs_Vectors is new Liblktlang_Support.Vectors
     (Referenced_Env);
   ...
   package Stored_Lookup_Result_Vectors is new Liblktlang_Support.Vectors
   ...
   package Lookup_Result_Item_Vectors is new Liblktlang_Support.Vectors
     (Lookup_Result_Item);
   ...
   package Internal_Map_Node_Vectors is new Liblktlang_Support.Vectors
     (Internal_Map_Node);
...
end Liblktlang_Support.Lexical_Envs_Impl;
