...
latex_documents = [
    ("index", "Langkit.tex", "Langkit Documentation", "AdaCore", "manual"),
]
...
man_pages = [("index", "langkit", "Langkit Documentation", ["AdaCore"], 1)]
...
epub_copyright = "2022-2023, AdaCore"
