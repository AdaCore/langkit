...
package body Liblktlang_Support.Adalog.Generic_Main_Support is
   ...
   procedure Solve_All (Rel : Relation; Timeout : Natural := 0) is
      ...
      package Solution_Vectors is new Liblktlang_Support.Vectors
        (Solution_Access);
      ...
      function Image is new Liblktlang_Support.Images.Array_Image
...
end Liblktlang_Support.Adalog.Generic_Main_Support;
