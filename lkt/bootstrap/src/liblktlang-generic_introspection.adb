...
declare
N_Bare_Imported_Name : constant Analysis.Imported_Name := N.As_Imported_Name;
begin
case Member is
when Member_Index_For_Imported_Name_F_Original_Name =>
declare
R : Internal_Acc_Node :=  new Internal_Rec_Node;
begin
Set_Node (R, N_Bare_Imported_Name.F_Original_Name);
Result := Internal_Value_Access (R);
exception
when Exc : others =>
if Implementation.Properties_May_Raise (Exc) then
...
when Member_Index_For_Imported_Name_F_Renaming =>
declare
R : Internal_Acc_Node :=  new Internal_Rec_Node;
begin
...
R : Internal_Acc_Node :=  new Internal_Rec_Node;
begin
Set_Node (R, N_Bare_Complex_Pattern.F_Pattern);
Result := Internal_Value_Access (R);
exception
when Exc : others =>
if Implementation.Properties_May_Raise (Exc) then
...
when Member_Index_For_Complex_Pattern_F_Details =>
declare
R : Internal_Acc_Node :=  new Internal_Rec_Node;
begin
Set_Node (R, N_Bare_Complex_Pattern.F_Details);
Result := Internal_Value_Access (R);
exception
when Exc : others =>
if Implementation.Properties_May_Raise (Exc) then
...
when Member_Index_For_Complex_Pattern_F_Predicate =>
declare
R : Internal_Acc_Node :=  new Internal_Rec_Node;
begin
Set_Node (R, N_Bare_Complex_Pattern.F_Predicate);
Result := Internal_Value_Access (R);
exception
when Exc : others =>
if Implementation.Properties_May_Raise (Exc) then
