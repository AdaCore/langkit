...
test_whitelist = {
    ...
    'exposed_bare_nodes', 'external', 'field_introspection', 'foreign_env_md',
    'full_sloc_image', 'ghost_nodes', 'hashes', 'import_argcount',
    'indent_trivia', 'is_a', 'let_underscore', 'lifetimes', 'logging',
    'lookup_token', 'lower_dispatch', 'lower_dispatch_rewrite', 'map_index',
    'match', 'memoized_big_table', 'memoized_env', 'memoized_inf_recurs',
    'memoized_property_array_arg', 'memoized_unit', 'memoized_unit_loading',
    'neq', 'new_node', 'newline', 'node_comparison', 'node_conversion',
    ...
    'private_predicate_props', 'properties_introspection',
