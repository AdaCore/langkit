...
package Liblktlang_Support.Text is
   ...
   --  Like :ada:ref:`Liblktlang_Support.Text.Encode`, but converts a string to
   --  text.
   ...
   --  :ada:ref:`Liblktlang_Support`, like pretty printing of diagnostics
   --  implemented in :ada:ref:`Liblktlang_Support.Diagnostics.Output`.
   --
