...
with Liblktlang_Support.Array_Utils;

package body Liblktlang_Support.Cheap_Sets is
   ...
   is new Liblktlang_Support.Array_Utils
...
end Liblktlang_Support.Cheap_Sets;
