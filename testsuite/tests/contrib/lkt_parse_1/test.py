...
test_whitelist = {
    ...
    'auto_ple_dispatcher', 'auto_populate', 'bare_lexing', 'big_integer',
    'c_text_to_locale_string', 'can_reach', 'categories', 'character', 'cond',
    'custom_parsing_rule', 'dflt_arg_val', 'dflt_arg_val_dispatch',
    'dflt_arg_val_predicate', 'dflt_field_val', 'domain_derived',
    'dynvar_bind', 'dynvars_dflt', 'early_binding_error', 'entity_bind',
    'entity_bind_2', 'entity_bind_3', 'entity_cast', 'entity_eq',
    'entity_field_access', 'entity_length', 'entity_map', 'entity_match',
    'entity_resolver', 'enum_node_inherit', 'enum_types', 'env_get_all',
    'equality', 'exposed_bare_nodes', 'external', 'field_introspection',
    'foreign_env_md', 'full_sloc_image', 'general', 'ghost_nodes', 'hashes',
    'if_then', 'import_argcount', 'indent_trivia', 'invalidation_during_mmz',
    'is_a', 'is_visible_from', 'let_underscore', 'lifetimes', 'logging',
    'lookup_token', 'lower_dispatch', 'lower_dispatch_null',
    'lower_dispatch_rewrite', 'map_index', 'match', 'memoized_big_table',
    'memoized_env', 'memoized_inf_recurs', 'memoized_property_array_arg',
    'memoized_property_error', 'memoized_unit', 'memoized_unit_loading', 'neq',
    'new_node', 'newline', 'node_comparison', 'node_conversion',
    'node_env_concrete_subclass', 'node_env_empty', 'node_negative_index',
    'node_none_check', 'node_type_introspection', 'null_checks',
    'null_list_get', 'null_node_prop', 'ple_after_reparse', 'ple_resilience',
    'ple_resilience_2', 'ple_subunits', 'ple_subunits_2', 'populate_error',
