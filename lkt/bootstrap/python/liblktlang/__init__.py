...
class GrammarRule(str, enum.Enum):
    ...
    neg_pattern_rule = 'neg_pattern_rule'
    pattern_binding_rule = 'pattern_binding_rule'
    complex_pattern_rule = 'complex_pattern_rule'
...
class LktNode:
    ...
    def p_prelude_unit(
        ...
        c_result = self._eval_field(AnalysisUnit._c_type(), _lkt_node_p_prelude_unit)
        result = AnalysisUnit._wrap(c_result)
...
class PatternMatchBranch(BaseMatchBranch):
    ...
    def f_pattern(
        ...
        :py:class:`ComplexPattern`, :py:class:`NotPattern`,
        :py:class:`OrPattern`
...
class Decl(LktNode):
    ...
    :py:class:`GrammarDecl`, :py:class:`LangkitRoot`, :py:class:`LexerDecl`,
...
class Expr(LktNode):
    ...
    :py:class:`Query`, :py:class:`RaiseExpr`, :py:class:`SubscriptExpr`,
    :py:class:`TryExpr`, :py:class:`UnOp`
    """
    __slots__ : Tuple[str, ...] = ()
...
class Query(Expr):
    ...
    def f_source(
        ...
        result = self._eval_astnode_field(_query_f_source)
    ...
    def f_pattern(
        ...
        result = self._eval_astnode_field(_query_f_pattern)
    ...
    def f_mapping(
        ...
        result = self._eval_astnode_field(_query_f_mapping)
    ...
    def f_guard(
        ...
        result = self._eval_astnode_field(_query_f_guard)
...
class PatternList(LktNodeBaseList):
    ...
    This list node can contain one of the following nodes:
    :py:class:`BindingPattern`, :py:class:`NotPattern`
...
class Pattern(LktNode):
    ...
    :py:class:`BoolPattern`, :py:class:`IntegerPattern`,
    :py:class:`ListPattern`, :py:class:`NullPattern`, :py:class:`OrPattern`,
    :py:class:`ParenPattern`, :py:class:`RegexPattern`,
    :py:class:`ScopedPattern`, :py:class:`TypePattern`
    """
    __slots__ : Tuple[str, ...] = ()
...
class AnyTypePattern(Pattern):
    ...
    Pattern that allows to match any type. Only usable as a ComplexPattern's
    left side pattern:
...
class BindingPattern(Pattern):
    ...
    Derived nodes: :py:class:`ComplexPattern`, :py:class:`EllipsisPattern`
    """
    __slots__ : Tuple[str, ...] = ()
...
class ComplexPattern(BindingPattern):
    """
    Subclass of :py:class:`BindingPattern`.
    ...
    * a when clause
    ...
    Derived nodes: :py:class:`RenamingComplexPattern`
    """
    __slots__ : Tuple[str, ...] = ()
    ...
    def f_pattern(
        ...
        """
        This field can contain one of the following nodes:
        :py:class:`AnyTypePattern`, :py:class:`BoolPattern`,
        :py:class:`IntegerPattern`, :py:class:`ListPattern`,
        :py:class:`NullPattern`, :py:class:`ParenPattern`,
        :py:class:`RegexPattern`, :py:class:`TypePattern`
        ...
        result = self._eval_astnode_field(_complex_pattern_f_pattern)
    ...
    def f_details(
        ...
        result = self._eval_astnode_field(_complex_pattern_f_details)
    ...
    def f_predicate(
        ...
        result = self._eval_astnode_field(_complex_pattern_f_predicate)



        return result

    _field_names = BindingPattern._field_names + (
        "f_pattern",
        "f_details",
        "f_predicate",
    )

    _kind_name = 'ComplexPattern'
...
class RenamingComplexPattern(ComplexPattern):
    """
    Subclass of :py:class:`ComplexPattern`.

    Special case of a complex pattern with no pattern part. This subclass
    exists only to facilitate the unparsing.
    ...
    _field_names = ComplexPattern._field_names + (
    )

    _kind_name = 'RenamingComplexPattern'
...
class EllipsisPattern(BindingPattern):
    """
    Subclass of :py:class:`BindingPattern`.
...
class ListPattern(Pattern):
    ...
    def f_sub_patterns(
        ...
        """
        This field contains a list that itself contains one of the following
        nodes: :py:class:`BindingPattern`, :py:class:`NotPattern`
...
class ScopedPattern(Pattern):
    ...
    Derived nodes: :py:class:`NotPattern`
    """
    __slots__ : Tuple[str, ...] = ()
    ...
    def f_sub_pattern(
        ...
        result = self._eval_astnode_field(_scoped_pattern_f_sub_pattern)
...
class NotPattern(ScopedPattern):
    """
    Subclass of :py:class:`ScopedPattern`.
    ...
    _field_names = ScopedPattern._field_names + (
    )
...
_lkt_node_p_prelude_unit = _import_func(
    'lkt_lkt_node_p_prelude_unit',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(AnalysisUnit._c_type)],
    ctypes.c_int
)
...
_query_f_source = _import_func(
    'lkt_query_f_source',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_query_f_pattern = _import_func(
    'lkt_query_f_pattern',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_query_f_mapping = _import_func(
    'lkt_query_f_mapping',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_query_f_guard = _import_func(
    'lkt_query_f_guard',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
...
_complex_pattern_f_pattern = _import_func(
    'lkt_complex_pattern_f_pattern',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_complex_pattern_f_details = _import_func(
    'lkt_complex_pattern_f_details',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
_complex_pattern_f_predicate = _import_func(
    'lkt_complex_pattern_f_predicate',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
...
_scoped_pattern_f_sub_pattern = _import_func(
    'lkt_scoped_pattern_f_sub_pattern',
    [ctypes.POINTER(_Entity_c_type),
     ctypes.POINTER(_Entity_c_type)],
    ctypes.c_int
)
...
_kind_to_astnode_cls = {
    ...
    44: TraitDecl,
    45: DeclAnnotation,
    46: DeclAnnotationArgs,
    47: DynEnvWrapper,
    48: ElsifBranch,
    49: EnumClassCase,
    50: ExcludesNullAbsent,
    51: ExcludesNullPresent,
    52: AnyOf,
    53: ArrayLiteral,
    54: CallExpr,
    55: LogicPredicate,
    56: LogicPropagateCall,
    57: BinOp,
    58: BlockExpr,
    59: CastExpr,
    60: DotExpr,
    61: ErrorOnNull,
    62: GenericInstantiation,
    63: ErrorGrammarExpr,
    64: GrammarCut,
    65: GrammarDiscard,
    66: GrammarDontSkip,
    ...
    69: GrammarOpt,
    70: GrammarOptError,
    71: GrammarOptErrorGroup,
    72: GrammarOptGroup,
    73: GrammarOrExpr,
    74: GrammarPick,
    75: GrammarImplicitPick,
    76: GrammarPredicate,
    77: GrammarRuleRef,
    78: GrammarSkip,
    79: GrammarStopCut,
    ...
    98: NumLit,
    99: BlockStringLit,
    100: ModuleDocStringLit,
    101: SingleLineStringLit,
    102: PatternSingleLineStringLit,
    103: LogicAssign,
    104: LogicExpr,
    105: LogicPropagate,
    106: LogicUnify,
    ...
    171: AnyTypePattern,
    172: ComplexPattern,
    173: RenamingComplexPattern,
    174: EllipsisPattern,
    175: BoolPatternFalse,
    176: BoolPatternTrue,
    177: IntegerPattern,
    178: ListPattern,
    179: NullPattern,
    ...
    184: NotPattern,
    185: TypePattern,
    186: DestructuringPatternDetail,
    187: FieldPatternDetail,
    188: PropertyPatternDetail,
    189: DefaultListTypeRef,
    190: FunctionTypeRef,
    191: GenericTypeRef,
    192: SimpleTypeRef,
    193: VarBind,
