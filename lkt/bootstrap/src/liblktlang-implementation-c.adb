...
package body Liblktlang.Implementation.C is
   ...
   Node_Kind_Names : constant array (Lkt_Node_Kind_Type) of Text_Access :=
     (Lkt_Argument => new Text_Type'(To_Text ("Argument")),
      ...
      Lkt_Import_All_From => new Text_Type'(To_Text ("ImportAllFrom")),
      Lkt_Import_From => new Text_Type'(To_Text ("ImportFrom")),
      Lkt_Error_Lexer_Case_Rule_Alt => new Text_Type'(To_Text ("ErrorLexerCaseRuleAlt")),
      ...
      Lkt_Error_Grammar_Expr => new Text_Type'(To_Text ("ErrorGrammarExpr")),
      ...
      Lkt_Imported_Id => new Text_Type'(To_Text ("ImportedId")),
      Lkt_Module_Id => new Text_Type'(To_Text ("ModuleId")),
      ...
      Lkt_Base_Import_List => new Text_Type'(To_Text ("BaseImportList")),
      ...
      Lkt_Imported_Name_List => new Text_Type'(To_Text ("ImportedNameList")),
      ...
      Lkt_Extended_Pattern => new Text_Type'(To_Text ("ExtendedPattern")),
      ...
      Lkt_Tuple_Pattern => new Text_Type'(To_Text ("TuplePattern")),
      ...
      Lkt_Selector_Pattern_Detail => new Text_Type'(To_Text ("SelectorPatternDetail")),
      Lkt_Selector_Call => new Text_Type'(To_Text ("SelectorCall")),
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Import_From_Range then
         ...
         begin
            Result := Import_From_F_Imported_Names
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_import_from_f_imported_names;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Lexer_Case_Rule_Cond_Alt_Range then
         ...
         begin
            Result := Lexer_Case_Rule_Cond_Alt_F_Send
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_lexer_case_rule_cond_alt_f_send;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Lexer_Case_Rule_Default_Alt_Range then
         ...
         declare
            ...
            Result : Bare_Lexer_Case_Rule_Send;
         begin
            Result := Lexer_Case_Rule_Default_Alt_F_Send
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_lexer_case_rule_default_alt_f_send;
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_fun_decl_p_find_all_overrides;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Def_Id_Range then
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_def_id_p_get_implementatinons;
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_def_id_p_completion_item_kind;
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_def_id_p_find_all_references;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Ref_Id_Range then
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_ref_id_p_referenced_defining_name;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Imported_Name_Range then

         declare
            

            Result : Bare_Imported_Id;
         begin
            Result := Imported_Name_F_Original_Name
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_imported_name_f_original_name;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Imported_Name_Range then
         ...
         declare
            ...
            Result : Bare_Def_Id;
         begin
            Result := Imported_Name_F_Renaming
              (Unwrapped_Node);
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Binding_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Binding_Pattern_F_Sub_Pattern
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_binding_pattern_f_sub_pattern;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Extended_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Extended_Pattern_F_Sub_Pattern
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_extended_pattern_f_sub_pattern;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Extended_Pattern_Range then
         ...
         begin
            Result := Extended_Pattern_F_Details
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_extended_pattern_f_details;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Filtered_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Filtered_Pattern_F_Sub_Pattern
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_filtered_pattern_f_sub_pattern;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Filtered_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Expr;
         begin
            Result := Filtered_Pattern_F_Predicate
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_filtered_pattern_f_predicate;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_List_Pattern_Range then
         ...
         begin
            Result := List_Pattern_F_Sub_Patterns
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_list_pattern_f_sub_patterns;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Or_Pattern_Range then
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_or_pattern_f_left_sub_pattern;
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_or_pattern_f_right_sub_pattern;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Paren_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Paren_Pattern_F_Sub_Pattern
              (Unwrapped_Node);
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Tuple_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Pattern_List;
         begin
            Result := Tuple_Pattern_F_Sub_Patterns
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_tuple_pattern_f_sub_patterns;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Type_Pattern_Range then
         ...
         declare
            ...
            Result : Bare_Type_Ref;
         begin
            Result := Type_Pattern_F_Type_Name
              (Unwrapped_Node);
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Field_Pattern_Detail_Range then
         ...
         declare
            ...
            Result : Bare_Id;
         begin
            Result := Field_Pattern_Detail_F_Id
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_field_pattern_detail_f_id;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Field_Pattern_Detail_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Field_Pattern_Detail_F_Expected_Value
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_field_pattern_detail_f_expected_value;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Property_Pattern_Detail_Range then
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_property_pattern_detail_f_call;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Property_Pattern_Detail_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Property_Pattern_Detail_F_Expected_Value
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_property_pattern_detail_f_expected_value;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Selector_Pattern_Detail_Range then
         ...
         begin
            Result := Selector_Pattern_Detail_F_Call
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_selector_pattern_detail_f_call;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Selector_Pattern_Detail_Range then
         ...
         declare
            ...
            Result : Bare_Pattern;
         begin
            Result := Selector_Pattern_Detail_F_Sub_Pattern
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_selector_pattern_detail_f_sub_pattern;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Selector_Call_Range then
         ...
         declare
            ...
            Result : Bare_Id;
         begin
            Result := Selector_Call_F_Quantifier
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_selector_call_f_quantifier;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Selector_Call_Range then
         ...
         declare
            ...
            Result : Bare_Id;
         begin
            Result := Selector_Call_F_Binding
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_selector_call_f_binding;
   ...
   begin
      ...
      if Unwrapped_Node.Kind in Lkt_Selector_Call_Range then
         ...
         declare
            ...
            Result : Bare_Expr;
         begin
            Result := Selector_Call_F_Selector_Call
              (Unwrapped_Node);
   ...
   exception
      when Exc : others =>
         Set_Last_Exception (Exc);
         return 0;
   end lkt_selector_call_f_selector_call;
...
function lkt_internal_complete_item_array_create (Length : int) return Internal_Complete_Item_Array_Access is
begin
   Clear_Last_Exception;
   return Create_Internal_Complete_Item_Array (Natural (Length));
exception
   when Exc : others =>
      Set_Last_Exception (Exc);
      return null;
end lkt_internal_complete_item_array_create;

procedure lkt_internal_complete_item_array_inc_ref (A : Internal_Complete_Item_Array_Access) is
begin
   Clear_Last_Exception;
   Inc_Ref (A);
exception
...
procedure lkt_internal_complete_item_array_dec_ref (A : Internal_Complete_Item_Array_Access) is
begin
   Clear_Last_Exception;
   declare
      A_Var : Internal_Complete_Item_Array_Access := A;
   begin
      Dec_Ref (A_Var);
   end;
exception
...
function lkt_internal_ref_result_array_create (Length : int) return Internal_Ref_Result_Array_Access is
begin
   Clear_Last_Exception;
...
exception
   when Exc : others =>
      Set_Last_Exception (Exc);
      return null;
end lkt_internal_ref_result_array_create;

procedure lkt_internal_ref_result_array_inc_ref (A : Internal_Ref_Result_Array_Access) is
begin
   Clear_Last_Exception;
   Inc_Ref (A);
exception
...
procedure lkt_internal_ref_result_array_dec_ref (A : Internal_Ref_Result_Array_Access) is
begin
   Clear_Last_Exception;
   declare
...
function lkt_analysis_unit_array_create (Length : int) return Internal_Unit_Array_Access is
begin
   Clear_Last_Exception;
...
exception
   when Exc : others =>
      Set_Last_Exception (Exc);
      return null;
end lkt_analysis_unit_array_create;

procedure lkt_analysis_unit_array_inc_ref (A : Internal_Unit_Array_Access) is
begin
   Clear_Last_Exception;
   Inc_Ref (A);
exception
...
procedure lkt_analysis_unit_array_dec_ref (A : Internal_Unit_Array_Access) is
begin
   Clear_Last_Exception;
   declare
