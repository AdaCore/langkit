...
package body ${ada_lib_name}.Rewriting_C is
   ...
   function From_C_Node_Kind (Kind : ${node_kind_type}) return Type_Ref
   is (To_Generic_Node_Type (${T.node_kind}'Enum_Val (Kind)));
   ...
   procedure C_Unparse
     (Handle : C_Node_Rewriting_Handle; Result : access ${text_type}) is
   begin
      Clear_Last_Exception;
      declare
   ...
   begin
      ...
      declare
         ...
         K : constant ${T.node_kind} := From_Generic_Node_Type (T);
      begin
   ...
   function C_Create_From_Template
     (Handle    : C_Rewriting_Handle;
      ...
      Rule      : ${grammar_rule_type}) return C_Node_Rewriting_Handle is
   begin
      Clear_Last_Exception;
      declare
