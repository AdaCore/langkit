...
-----------------------------
-- Liblktlang_Support.Vectors --
-----------------------------

package body Liblktlang_Support.Vectors is
   ...
   is
   begin
      for I in Index .. Self.Length - Count loop
         Set (Self, I, Get (Self, I + Count));
      end loop;
...
end Liblktlang_Support.Vectors;
