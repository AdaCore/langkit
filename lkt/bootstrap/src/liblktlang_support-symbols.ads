...
--  (:ada:ref:`Liblktlang_Support.Text.Text_Type`) identifiers. This is used in
...
package Liblktlang_Support.Symbols is
...
private
   ...
   is new Liblktlang_Support.Vectors (Text_Access);
...
end Liblktlang_Support.Symbols;
