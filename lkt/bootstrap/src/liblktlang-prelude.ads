package Liblktlang.Prelude is
   Content : constant String :=
      "# In this file, the RootNode__ type designates the root node type from the" & Character'Val (10)
       ...
       & Character'Val (10)
       & "@builtin" & Character'Val (10)
       & "@covariant" & Character'Val (10)
       & "generic[T]" & Character'Val (10)
       & "struct Stream implements Indexable[T], Iterable[T] {" & Character'Val (10)
       & "}" & Character'Val (10)
       & Character'Val (10)
       ...
       & "}" & Character'Val (10)
       & Character'Val (10)
       & "struct __default_metadata {" & Character'Val (10)
       & "    |"" Default Metadata type, to be used when the Langkit specification does" & Character'Val (10)
       & "    |"" not have a type annotated with ``@metadata``." & Character'Val (10)
       & "    |""" & Character'Val (10)
       & "    |"" 1. This is hidden in a scope so that by default it is unreachable from" & Character'Val (10)
       & "    |""    user code. It is still registered in the root scope as" & Character'Val (10)
       & "    |""    ``__default_metadata`` (for convenient access to it)." & Character'Val (10)
       & "    |""" & Character'Val (10)
       & "    |"" 2. If user code defines a Metadata struct, it is registered in the root" & Character'Val (10)
       & "    |""    scope as ``__user_metadata``." & Character'Val (10)
       & "    |""" & Character'Val (10)
       & "    |"" 3. A dynamic entity resolver inserted in the root scope will resolve to" & Character'Val (10)
       & "    |""    the user Metadata (if available) or the default one (if not)." & Character'Val (10)
       & "    @metadata" & Character'Val (10)
       & "    struct Metadata {" & Character'Val (10)
       & "    }" & Character'Val (10)
       & "}" & Character'Val (10)
       & Character'Val (10)
