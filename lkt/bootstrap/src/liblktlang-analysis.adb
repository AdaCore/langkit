...
package body Liblktlang.Analysis is
   ...
   -----------------------
      ...
      begin
         ...
         Check_Safety_Net (Node);
            ...
            if N.Kind in Lkt_Block_Expr_Clause_Range then
      ...
      begin
         ...
         Check_Safety_Net (Node);
            ...
            if N.Kind in Lkt_Complex_Pattern_Range then
      ...
      begin
         ...
         Check_Safety_Net (Node);
            ...
            if N.Kind in Lkt_Error_Decl_Range then
      ...
      begin
         ...
         Check_Safety_Net (Node);
            ...
            if N.Kind in Lkt_Imported_Name_Range then
      ...
      begin
         ...
         Check_Safety_Net (Node);
            ...
            if N.Kind in Lkt_Imported_Name_List_Range then
      ...
      begin
         if N = null then
            return No_Renaming_Complex_Pattern;
         end if;
         ...
         Check_Safety_Net (Node);
            ...
            if N.Kind in Lkt_Renaming_Complex_Pattern_Range then
 ...
 is
   ...
   begin
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Block_Expr_F_Clauses (Node.Internal.Node);
         if Result = null then
            return No_Lkt_Node_List;
         else
            return (Internal   => (Result, Node.Internal.Info),
   ...
   begin
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Block_Expr_Clause_F_Clause (Node.Internal.Node);
         if Result = null then
            return No_Lkt_Node;
         else
            return (Internal   => (Result, Node.Internal.Info),
   ...
   function F_Pattern
     (Node : Complex_Pattern'Class) return Pattern
   is
      Result : Bare_Pattern;
   begin
      if Node.Internal.Node = null then
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Complex_Pattern_F_Pattern (Node.Internal.Node);
         if Result = null then
            return No_Pattern;
         else
            return (Internal   => (Result, Node.Internal.Info),
   ...
   begin
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Complex_Pattern_F_Details (Node.Internal.Node);
         if Result = null then
            return No_Pattern_Detail_List;
         else
            return (Internal   => (Result, Node.Internal.Info),
   ...
   function F_Predicate
     (Node : Complex_Pattern'Class) return Expr
   is
      Result : Bare_Expr;
   begin
      if Node.Internal.Node = null then
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Complex_Pattern_F_Predicate (Node.Internal.Node);
         if Result = null then
            return No_Expr;
         else
            return (Internal   => (Result, Node.Internal.Info),
   ...
   begin
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Imported_Name_F_Original_Name (Node.Internal.Node);
         if Result = null then
            return No_Imported_Id;
         else
            return (Internal   => (Result, Node.Internal.Info),
   ...
   begin
      ...
      Check_Safety_Net (Node);
      Result := Implementation.Imported_Name_F_Renaming (Node.Internal.Node);
         if Result = null then
            return No_Def_Id;
         else
            return (Internal   => (Result, Node.Internal.Info),
         ...
         function List_Child
           (Node : Imported_Name_List'Class; Index : Positive) return Imported_Name
         is
            Result : Lkt_Node;
         begin
            if Node.Internal.Node = null then
            ...
            Result := Node.Child (Index);
            return Result.As_Imported_Name;
         end List_Child;

         

         function Imported_Name_List_First (Node : Imported_Name_List) return Positive is
         begin
            if Node.Internal.Node = null then
               raise Precondition_Failure with "null node argument";
            end if;
         ...
         function Imported_Name_List_Next
           (Node : Imported_Name_List; Cursor : Positive) return Positive is
         begin
            if Node.Internal.Node = null then
               raise Precondition_Failure with "null node argument";
            end if;
         ...
         function Imported_Name_List_Has_Element
           (Node : Imported_Name_List; Cursor : Positive) return Boolean is
         begin
            if Node.Internal.Node = null then
               raise Precondition_Failure with "null node argument";
            end if;
         ...
         function Imported_Name_List_Element
           (Node : Imported_Name_List; Cursor : Positive) return Imported_Name'Class
         is
            Child : Lkt_Node;
         begin
            if Node.Internal.Node = null then
            ...
            Child := Node.Child (Cursor);
            return Imported_Name'(Child.As_Imported_Name);
         end;
