...
package body Liblktlang_Support.Lexical_Envs_Impl is
   ...
   package Env_Pair_Vectors is new Liblktlang_Support.Vectors (Env_Pair);
                  ...
                  for I in V.First_Index .. V.Last_Index loop
                     ...
                     begin
                        Append
                          (Result,
                           Sub_Prefix & "  "
                           & Liblktlang_Support.Text.Image (+Pair.Key) & ": "
                           & Image (Pair.Value)
                           & ASCII.LF);
