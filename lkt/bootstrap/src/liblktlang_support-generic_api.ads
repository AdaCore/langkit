...
package Liblktlang_Support.Generic_API is
   ...
   --  :ada:ref:`Liblktlang_Support.Generic_API` packages take, in one way or
   ...
   --  instance a :ada:ref:`Liblktlang_Support.Generic_API.Analysis.Lk_Node`
   ...
   --  :ada:ref:`Liblktlang_Support.Generic_API.Analysis.No_Lk_Node` for their
   --  :ada:ref:`Liblktlang_Support.Generic_API.Analysis.Lk_Node` argument. The
   --  special :ada:ref:`Liblktlang_Support.Generic_API.Analysis.No_Lk_Node` value
   --  contains no reference to a particular Langkit-generated library. So even
   --  though such subprograms take a
   --  :ada:ref:`Liblktlang_Support.Generic_API.Analysis.Lk_Node` argument, they
...
private
   ...
   type Any_Language_Id is
     access constant Liblktlang_Support.Internal.Descriptor.Language_Descriptor;
...
end Liblktlang_Support.Generic_API;
