...
package body ${ada_lib_name}.Lexer_Implementation is
   ...
   procedure Set_Default_Charset
     (Input : in out Internal_Lexer_Input; Charset : Unbounded_String) is
   begin
      if Input.Kind in Undecoded_Lexer_Input
         and then Input.Charset = Null_Unbounded_String
      then
         Input.Charset := Charset;
      end if;
   end Set_Default_Charset;
