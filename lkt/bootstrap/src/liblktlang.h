...
typedef enum {
         ...
         *
         * This list node can contain one of the following nodes:
         * ``lkt_complex_pattern``, ``lkt_ellipsis_pattern``,
         * ``lkt_not_pattern``
         *
         * This node type has no derivation.
         */
         ...
         *
         * Derived nodes: ``lkt_any_type_pattern``, ``lkt_bool_pattern``,
         * ``lkt_complex_pattern``, ``lkt_ellipsis_pattern``,
         * ``lkt_integer_pattern``, ``lkt_list_pattern``, ``lkt_not_pattern``,
         * ``lkt_null_pattern``, ``lkt_or_pattern``, ``lkt_paren_pattern``,
         * ``lkt_regex_pattern``, ``lkt_type_pattern``
         */
    

        /*
         * Pattern that allows to match any type. Only usable as a
         * ComplexPattern's left side pattern:
         *
         * .. code::
         *
         *    *(f_field: BasicDecl(...))
         ...
         * .. code::
         *
         *    o@ObjectDecl(field: Pattern, prop(): Pattern)
         *    when foo(o) == 42
         *
         * Derived nodes: ``lkt_renaming_complex_pattern``
         */
        lkt_complex_pattern = 174,
    

        /*
         * Special case of a complex pattern with no pattern part. This
         * subclass exists only to facilitate the unparsing.
         *
         * This node type has no derivation.
         */
...
typedef enum {
      ...
      lkt_member_ref_argument_f_value
        = 21,
      lkt_member_ref_import_f_imported_names
        = 22,
      lkt_member_ref_import_all_from_f_module_name
        = 23,
      lkt_member_ref_import_from_f_module_name
        = 24,
      ...
      lkt_member_ref_lexer_case_rule_send_f_match_size
        = 160,
      lkt_member_ref_complex_pattern_f_decl
        = 161,
      lkt_member_ref_complex_pattern_f_pattern
        = 162,
      lkt_member_ref_complex_pattern_f_details
        = 163,
      lkt_member_ref_complex_pattern_f_predicate
        = 164,
      ...
      lkt_member_ref_lkt_node_p_indexable_trait
        = 203,
      lkt_member_ref_lkt_node_p_iterable_gen_trait
        = 204,
      lkt_member_ref_lkt_node_p_iterable_trait
        = 205,
 ...
 */
extern int lkt_lkt_node_p_iterable_gen_trait(
    lkt_node *node,
 ...
 */
extern int lkt_lkt_node_p_iterable_trait(
    lkt_node *node,
 ...
 * Load them if needed.
 */
extern int lkt_base_import_p_referenced_units(
    lkt_node *node,


    lkt_analysis_unit_array *value_p
);
 ...
 * When there are no parsing errors, this field is never null.
 */
extern int lkt_import_f_imported_names(
    lkt_node *node,
 ...
 * When there are no parsing errors, this field is never null.
 */
extern int lkt_import_all_from_f_module_name(
    lkt_node *node,
 ...
 * When there are no parsing errors, this field is never null.
 */
extern int lkt_import_from_f_module_name(
    lkt_node *node,
...
/*
 * This field can contain one of the following nodes: ``lkt_complex_pattern``,
 * ``lkt_not_pattern``, ``lkt_or_pattern``
 *
 * When there are no parsing errors, this field is never null.
 */
 ...
 */
extern int lkt_lkt_node_base_list_is_empty_list(
    lkt_node *node,
 ...
 * This field may be null even when there are no parsing errors.
 */
extern int lkt_complex_pattern_f_decl(
    lkt_node *node,
 ...
 * ``lkt_bool_pattern``, ``lkt_integer_pattern``, ``lkt_list_pattern``,
 * ``lkt_null_pattern``, ``lkt_paren_pattern``, ``lkt_regex_pattern``,
 * ``lkt_type_pattern``
 *
 * This field may be null even when there are no parsing errors.
 */
extern int lkt_complex_pattern_f_pattern(
    lkt_node *node,
 ...
 * When there are no parsing errors, this field is never null.
 */
extern int lkt_complex_pattern_f_details(
    lkt_node *node,
 ...
 * This field may be null even when there are no parsing errors.
 */
extern int lkt_complex_pattern_f_predicate(
    lkt_node *node,
...
/*
 * This field contains a list that itself contains one of the following nodes:
 * ``lkt_complex_pattern``, ``lkt_ellipsis_pattern``, ``lkt_not_pattern``
 *
 * When there are no parsing errors, this field is never null.
 */
...
/*
 * Return 0 if the last API call returned without error. Otherwise, return 1
 * and copy exception details into EXC (which must be free'd once done with it:
 * see ``lkt_free_exception``.
 */
extern const int
lkt_copy_last_exception(lkt_exception *exc);
 ...
 */
extern void
lkt_free_last_exception(lkt_exception *exc);
...
/*
 * Return the text associated to the given unit with modified parts formatted
 * if possible.
 */
extern void
lkt_rewriting_unit_unparse_with_partial_formatting(
    lkt_unit_rewriting_handle handle,
    lkt_text *result
);
