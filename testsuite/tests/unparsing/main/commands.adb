...
begin
   ...
   Check ("cmd_match3.json", "var i: Int = 2+j;");
   Check ("cmd_match4.json", "var v:Int=f(1);");
   Check ("cmd_match5.json", "var v:Int=f(1);");
   Check ("cmd_match6.json", "null var v1:T=1; var v2:T=2;");
   Check ("cmd_match7.json", "var v1:T=1; var v2:T=1+2; var v3:T=a.b;");
   Check ("cmd_match8.json", "var i: Int = -2+2;");
