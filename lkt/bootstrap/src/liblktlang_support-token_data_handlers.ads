...
package Liblktlang_Support.Token_Data_Handlers is
   ...
   package Token_Vectors is new Liblktlang_Support.Vectors
     (Element_Type => Stored_Token_Data);
   package Text_Vectors is new Liblktlang_Support.Vectors
     (Element_Type => Text_Access);
   package Trivia_Vectors is new Liblktlang_Support.Vectors
     (Element_Type => Trivia_Node);
   package Integer_Vectors is new Liblktlang_Support.Vectors
   ...
   package Token_Index_Vectors is new Liblktlang_Support.Vectors
     (Element_Type => Token_Index);

   package Index_Vectors is new Liblktlang_Support.Vectors (Positive);
...
end Liblktlang_Support.Token_Data_Handlers;
