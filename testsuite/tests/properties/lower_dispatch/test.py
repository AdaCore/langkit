...
class Expr(FooNode):
    ...
    evaluate_abstract = AbstractProperty(T.Integer, public=True)
    evaluate_rtcheck = AbstractProperty(T.Integer, public=True,
                                        runtime_check=True)
    ...
    evaluate_entity = AbstractProperty(T.Integer, public=True)
