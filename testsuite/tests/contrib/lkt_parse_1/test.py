...
test_whitelist = {
    ...
    'dflt_field_val', 'domain_derived', 'dynvar_bind', 'dynvars_dflt',
    ...
    'invalidation_during_mmz', 'is_a', 'is_visible_from', 'let_underscore',
    'lifetimes', 'logging', 'lookup_token', 'lower_dispatch',
    'lower_dispatch_null', 'lower_dispatch_rewrite', 'map_index', 'match',
    'memoized_big_table', 'memoized_env', 'memoized_inf_recurs',
    'memoized_property_array_arg', 'memoized_property_error', 'memoized_unit',
