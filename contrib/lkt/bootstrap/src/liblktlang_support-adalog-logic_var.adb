...
with Liblktlang_Support.Adalog.Debug; use Liblktlang_Support.Adalog.Debug;

package body Liblktlang_Support.Adalog.Logic_Var is
...
end Liblktlang_Support.Adalog.Logic_Var;
