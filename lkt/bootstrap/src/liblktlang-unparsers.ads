      ...
      Token_Unparser_73 : aliased constant Token_Unparser_Impl :=
        (Token_Index_For_Lkt_R_Brace, Text_For_Token_Unparser_73'Access);
            ...
            := (N               => 2,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Binding_Pattern_F_Decl, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   2 => (Member_Index_For_Binding_Pattern_F_Sub_Pattern, Token_Sequence_36'Access, Empty_Token_Sequence, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence,
                   2 => Empty_Token_Sequence));
         ...
         Bare_Ellipsis_Pattern_Fields_Unparser_List
            ...
            := (N               => 1,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Ellipsis_Pattern_F_Binding, Empty_Token_Sequence, Token_Sequence_36'Access, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence));
         ...
         Unparser_For_Block_Expr_Clause : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            ...
            Post_Tokens => Token_Sequence_24'Access);
         ...
         Unparser_For_Env_Spec_Decl : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            ...
            Post_Tokens => Token_Sequence_84'Access);
