...
private package Liblktlang.Unparsers is
   ...
   Token_Newlines : aliased constant Token_Newline_Table_Impl :=
     (Token_Index_For_Lkt_Amp => False,
      ...
      Token_Index_For_Lkt_From_Kw => False,
      ...
      Token_Index_For_Lkt_Select_Kw => False,
      ...
      Token_Unparser_77 : aliased constant Token_Unparser_Impl :=
        (Token_Index_For_Lkt_R_Brace, Text_For_Token_Unparser_77'Access);
         ...
         Token_Sequence_7 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_2'Access, 2 => Token_Unparser_59'Access);
         ...
         Token_Sequence_20 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_11'Access, 2 => Token_Unparser_53'Access, 3 => Token_Unparser_29'Access);
         ...
         Token_Sequence_56 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_46'Access, 2 => Token_Unparser_29'Access);
         ...
         Token_Sequence_59 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_48'Access, 2 => Token_Unparser_61'Access, 3 => Token_Unparser_52'Access);
         ...
         Token_Sequence_62 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_50'Access, 2 => Token_Unparser_6'Access);
         ...
         Token_Sequence_72 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_59'Access, 2 => Token_Unparser_27'Access);
         ...
         Token_Sequence_77 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_65'Access, 2 => Token_Unparser_4'Access);
         Token_Sequence_78 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_66'Access, 2 => Token_Unparser_4'Access);
         ...
         Token_Sequence_87 : aliased constant Token_Sequence_Impl :=
           (1 => Token_Unparser_74'Access, 2 => Token_Unparser_34'Access);
         ...
         Bare_Import_All_From_Fields_Unparser_List
            : aliased constant Field_Unparser_List_Impl
            := (N               => 1,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Base_Import_F_Module_Name, Empty_Token_Sequence, Empty_Token_Sequence, False)),
         ...
         Bare_Import_From_Fields_Unparser_List
            : aliased constant Field_Unparser_List_Impl
            := (N               => 2,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Base_Import_F_Module_Name, Empty_Token_Sequence, Empty_Token_Sequence, False),
            ...
            := (N               => 4,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Decl_F_Syn_Name, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   ...
                   3 => (Member_Index_For_Field_Decl_F_Trait_Ref, Token_Sequence_60'Access, Empty_Token_Sequence, False),
            ...
            := (N               => 5,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Decl_F_Syn_Name, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   ...
                   4 => (Member_Index_For_Fun_Decl_F_Trait_Ref, Token_Sequence_60'Access, Empty_Token_Sequence, False),
            ...
            := (N               => 4,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Decl_F_Syn_Name, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   ...
                   3 => (Member_Index_For_Type_Decl_F_Traits, Token_Sequence_60'Access, Empty_Token_Sequence, True),
                   4 => (Member_Index_For_Named_Type_Decl_F_Decls, Empty_Token_Sequence, Empty_Token_Sequence, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence,
                   2 => Empty_Token_Sequence,
                   3 => Empty_Token_Sequence,
                   4 => Token_Sequence_86'Access));
         ...
         Bare_Enum_Type_Decl_Fields_Unparser_List
            ...
            := (N               => 4,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Decl_F_Syn_Name, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   2 => (Member_Index_For_Type_Decl_F_Traits, Token_Sequence_60'Access, Empty_Token_Sequence, True),
                   3 => (Member_Index_For_Enum_Type_Decl_F_Literals, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   4 => (Member_Index_For_Named_Type_Decl_F_Decls, Empty_Token_Sequence, Empty_Token_Sequence, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence,
                   2 => Empty_Token_Sequence,
                   3 => Token_Sequence_87'Access,
                   4 => Empty_Token_Sequence));
         ...
         Bare_Query_Fields_Unparser_List
            : aliased constant Field_Unparser_List_Impl
            := (N               => 4,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Query_F_Source, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   2 => (Member_Index_For_Query_F_Pattern, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   3 => (Member_Index_For_Query_F_Mapping, Token_Sequence_75'Access, Empty_Token_Sequence, False),
                   4 => (Member_Index_For_Query_F_Guard, Token_Sequence_58'Access, Empty_Token_Sequence, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence,
                   2 => Token_Sequence_66'Access,
                   3 => Empty_Token_Sequence,
                   4 => Empty_Token_Sequence));
            ...
            := (N               => 2,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Try_Expr_F_Try_Expr, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   2 => (Member_Index_For_Try_Expr_F_Or_Expr, Token_Sequence_49'Access, Empty_Token_Sequence, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence,
                   2 => Empty_Token_Sequence));
         ...
         Bare_Imported_Name_Fields_Unparser_List
            : aliased constant Field_Unparser_List_Impl
            := (N               => 2,
                Field_Unparsers =>
                  (1 => (Member_Index_For_Imported_Name_F_Original_Name, Empty_Token_Sequence, Empty_Token_Sequence, False),
                   2 => (Member_Index_For_Imported_Name_F_Renaming, Token_Sequence_42'Access, Empty_Token_Sequence, False)),
                Inter_Tokens    =>
                  (1 => Empty_Token_Sequence,
                   2 => Empty_Token_Sequence));
         ...
         Unparser_For_Import_All_From : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            Pre_Tokens => Token_Sequence_54'Access,
            Field_Unparsers => Bare_Import_All_From_Fields_Unparser_List'Access,
            Post_Tokens => Token_Sequence_62'Access);
      

         Unparser_For_Import_From : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            Pre_Tokens => Token_Sequence_54'Access,
            Field_Unparsers => Bare_Import_From_Fields_Unparser_List'Access,
            Post_Tokens => Empty_Token_Sequence);
         ...
         Unparser_For_Env_Spec_Decl : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            ...
            Post_Tokens => Token_Sequence_90'Access);
         ...
         Unparser_For_Imported_Id : aliased constant Node_Unparser_Impl :=
           (Kind => Token);
      

         Unparser_For_Module_Id : aliased constant Node_Unparser_Impl :=
           (Kind => Token);
         ...
         Unparser_For_Query : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            Pre_Tokens => Token_Sequence_54'Access,
            Field_Unparsers => Bare_Query_Fields_Unparser_List'Access,
            Post_Tokens => Empty_Token_Sequence);
         ...
         Unparser_For_Imported_Name : aliased constant Node_Unparser_Impl :=
           (Kind => Regular,
            Pre_Tokens => Empty_Token_Sequence,
            Field_Unparsers => Bare_Imported_Name_Fields_Unparser_List'Access,
            Post_Tokens => Empty_Token_Sequence);
         ...
         Unparser_For_Base_Import_List : aliased constant Node_Unparser_Impl :=
           (Kind => List,
            Separator => null,
            Sep_Extra => Allow_None);
         ...
         Unparser_For_Any_Of_List : aliased constant Node_Unparser_Impl :=
           (Kind => List,
            Separator => Token_Unparser_75'Access,
            Sep_Extra => Allow_None);
         ...
         Unparser_For_Imported_Name_List : aliased constant Node_Unparser_Impl :=
           (Kind => List,
            Separator => Token_Unparser_8'Access,
            Sep_Extra => Allow_None);
   ...
   Node_Unparsers : aliased constant Node_Unparser_Map_Impl := (
         ...
         ,
         Type_Index_For_Base_Import => null
         ,
         Type_Index_For_Import => Unparser_For_Import'Access
         ,
         Type_Index_For_Import_All_From => Unparser_For_Import_All_From'Access
         ,
         Type_Index_For_Import_From => Unparser_For_Import_From'Access
         ,
         ...
         ,
         Type_Index_For_Imported_Id => Unparser_For_Imported_Id'Access
         ,
         Type_Index_For_Module_Id => Unparser_For_Module_Id'Access
         ,
         ...
         ,
         Type_Index_For_Query => Unparser_For_Query'Access
         ,
         ...
         ,
         Type_Index_For_Imported_Name => Unparser_For_Imported_Name'Access
         ,
         ...
         ,
         Type_Index_For_Base_Import_List => Unparser_For_Base_Import_List'Access
         ,
         ...
         ,
         Type_Index_For_Imported_Name_List => Unparser_For_Imported_Name_List'Access
         ,
   ...
   Default_Config : aliased constant String :=
      ...
      & "    ""ImportedIdList"": {" & Character'Val (10)
      & "        ""sep"": [""recurse"", ""softline""]" & Character'Val (10)
      & "    }," & Character'Val (10)
