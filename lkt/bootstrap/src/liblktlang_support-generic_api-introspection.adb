...
pragma Unreferenced (Liblktlang_Support.Internal.Descriptor);

package body Liblktlang_Support.Generic_API.Introspection is

   use Liblktlang_Support.Errors.Introspection;
   ...
   function "+" is new Ada.Unchecked_Conversion
     (Liblktlang_Support.Internal.Introspection.Internal_Value_Access,
      Liblktlang_Support.Generic_API.Introspection.Internal_Value_Access);
   function "+" is new Ada.Unchecked_Conversion
     (Liblktlang_Support.Generic_API.Introspection.Internal_Value_Access,
      Liblktlang_Support.Internal.Introspection.Internal_Value_Access);
...
end Liblktlang_Support.Generic_API.Introspection;
