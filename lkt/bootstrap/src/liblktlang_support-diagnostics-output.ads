...
--  :ada:ref:`Liblktlang_Support.Diagnostics.Diagnostic` for a source buffer, in a
...
package Liblktlang_Support.Diagnostics.Output is
...
end Liblktlang_Support.Diagnostics.Output;
