...
generic
   with package Solver_Ifc
     is new Liblktlang_Support.Adalog.Solver_Interface (<>);
package Liblktlang_Support.Adalog.Solver is
   ...
   package Relation_Vectors is new Liblktlang_Support.Vectors
