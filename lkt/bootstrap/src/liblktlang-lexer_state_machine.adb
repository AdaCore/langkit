   ...
   begin
      ...
      Match_Ignore := False;
         ...
         begin
            ...
            case Input_Char is
               when Character_Type'Val (16#0#) .. '!' | '#' .. Character_Type'Val (16#10ffff#) => goto State_141;
               when '"' => goto State_142;
         ...
         begin
            ...
            case Input_Char is
               ...
               when 'l' => goto State_154;
               when 'o' => goto State_155;
