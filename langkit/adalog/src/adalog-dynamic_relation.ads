...
--  Beware, some meta stuff going on here. This is an instantiation of the
--  Relation_Interface package on Rel itself, which implements the relation
--  protocol. The only use for this is to be able to have an instance of
