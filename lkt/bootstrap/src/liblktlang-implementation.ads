...
private package Liblktlang.Implementation is
   ...
   function Kind (Node : Bare_Lkt_Node) return Lkt_Node_Kind_Type;
         ...
         subtype Bare_Block_Expr_Clause is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Block_Expr_Clause)
               or else Kind (Bare_Block_Expr_Clause) in Lkt_Block_Expr_Clause_Range;
         ...
         subtype Bare_Error_Decl is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Error_Decl)
               or else Kind (Bare_Error_Decl) in Lkt_Error_Decl_Range;
         ...
         subtype Bare_Imported_Name is Bare_Lkt_Node
            with Dynamic_Predicate =>
         ...
         subtype Bare_Imported_Name_List is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Imported_Name_List)
               or else Kind (Bare_Imported_Name_List) in Lkt_Imported_Name_List_Range;
         ...
         subtype Bare_Pattern_Detail_List is Bare_Lkt_Node
            with Dynamic_Predicate =>
               ...
               or else Kind (Bare_Pattern_Detail_List) in Lkt_Pattern_Detail_List_Range;
         subtype Bare_Pattern_List is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Pattern_List)
               or else Kind (Bare_Pattern_List) in Lkt_Pattern_List_Range;
         ...
         subtype Bare_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               ...
               or else Kind (Bare_Pattern) in Lkt_Pattern;
         subtype Bare_Any_Type_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Any_Type_Pattern)
               or else Kind (Bare_Any_Type_Pattern) in Lkt_Any_Type_Pattern_Range;
         subtype Bare_Binding_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Binding_Pattern)
               or else Kind (Bare_Binding_Pattern) in Lkt_Binding_Pattern;
         subtype Bare_Complex_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Complex_Pattern)
               or else Kind (Bare_Complex_Pattern) in Lkt_Complex_Pattern_Range;
         subtype Bare_Renaming_Complex_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Renaming_Complex_Pattern)
               or else Kind (Bare_Renaming_Complex_Pattern) in Lkt_Renaming_Complex_Pattern_Range;
         subtype Bare_Ellipsis_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Ellipsis_Pattern)
               or else Kind (Bare_Ellipsis_Pattern) in Lkt_Ellipsis_Pattern_Range;
         ...
         subtype Bare_Scoped_Pattern is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Scoped_Pattern)
               or else Kind (Bare_Scoped_Pattern) in Lkt_Scoped_Pattern_Range;
         ...
         subtype Bare_Pattern_Detail is Bare_Lkt_Node
            with Dynamic_Predicate =>
         ...
         subtype Bare_Field_Pattern_Detail is Bare_Lkt_Node
            with Dynamic_Predicate =>
               ...
               or else Kind (Bare_Field_Pattern_Detail) in Lkt_Field_Pattern_Detail_Range;
         subtype Bare_Property_Pattern_Detail is Bare_Lkt_Node
            with Dynamic_Predicate =>
               Is_Null (Bare_Property_Pattern_Detail)
               or else Kind (Bare_Property_Pattern_Detail) in Lkt_Property_Pattern_Detail_Range;
  ...
  procedure Free is new Ada.Unchecked_Deallocation
   ...
   -----------------------------------------------
      ...
      type Internal_Entity_Pattern;
      

         
      type Internal_Entity_Any_Type_Pattern;
      ...
      type Internal_Entity_Block_Expr_Clause;
      ...
      type Internal_Entity_Complex_Pattern;
      ...
      type Internal_Entity_Ellipsis_Pattern;
      ...
      type Internal_Entity_Field_Pattern_Detail;
      ...
      type Internal_Entity_Imported_Name;
      

         
      type Internal_Entity_Imported_Name_List;
      ...
      type Internal_Entity_Scoped_Pattern;
      ...
      type Internal_Entity_Pattern_Detail_List;
      

         
      type Internal_Entity_Pattern_List;
      ...
      type Internal_Entity_Property_Pattern_Detail;
      ...
      type Internal_Entity_Renaming_Complex_Pattern;
   ...
   -----------------------------------------
      ...
      type Internal_Entity_Pattern is record

               Node : aliased Bare_Pattern;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Pattern : constant Internal_Entity_Pattern;
      ...
      function Trace_Image (R : Internal_Entity_Pattern) return String;
      ...
      type Internal_Entity_Any_Type_Pattern is record

               Node : aliased Bare_Any_Type_Pattern;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Any_Type_Pattern : constant Internal_Entity_Any_Type_Pattern;
      ...
      function Trace_Image (R : Internal_Entity_Any_Type_Pattern) return String;
      ...
      function Equivalent (L, R : Internal_Entity_Binding_Pattern) return Boolean;
      ...
      type Internal_Entity_Block_Expr_Clause is record

               Node : aliased Bare_Block_Expr_Clause;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Block_Expr_Clause : constant Internal_Entity_Block_Expr_Clause;
      ...
      function Trace_Image (R : Internal_Entity_Block_Expr_Clause) return String;
      ...
      type Internal_Entity_Complex_Pattern is record

               Node : aliased Bare_Complex_Pattern;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Complex_Pattern : constant Internal_Entity_Complex_Pattern;
      ...
      function Trace_Image (R : Internal_Entity_Complex_Pattern) return String;
      ...
      type Internal_Entity_Ellipsis_Pattern is record

               Node : aliased Bare_Ellipsis_Pattern;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Ellipsis_Pattern : constant Internal_Entity_Ellipsis_Pattern;
      ...
      function Trace_Image (R : Internal_Entity_Ellipsis_Pattern) return String;
      ...
      type Internal_Entity_Field_Pattern_Detail is record

               Node : aliased Bare_Field_Pattern_Detail;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Field_Pattern_Detail : constant Internal_Entity_Field_Pattern_Detail;
      ...
      function Trace_Image (R : Internal_Entity_Field_Pattern_Detail) return String;
      ...
      type Internal_Entity_Imported_Name is record

               Node : aliased Bare_Imported_Name;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Imported_Name : constant Internal_Entity_Imported_Name;
      ...
      function Trace_Image (R : Internal_Entity_Imported_Name) return String;
      ...
      type Internal_Entity_Imported_Name_List is record

               Node : aliased Bare_Imported_Name_List;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Imported_Name_List : constant Internal_Entity_Imported_Name_List;
      ...
      function Trace_Image (R : Internal_Entity_Imported_Name_List) return String;
      ...
      type Internal_Entity_Scoped_Pattern is record

               Node : aliased Bare_Scoped_Pattern;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Scoped_Pattern : constant Internal_Entity_Scoped_Pattern;


      function Create_Internal_Entity_Scoped_Pattern
        (Node : Bare_Scoped_Pattern; Info : Internal_Entity_Info)
         return Internal_Entity_Scoped_Pattern;

      function Equivalent (L, R : Internal_Entity_Scoped_Pattern) return Boolean;

   


      function Trace_Image (R : Internal_Entity_Scoped_Pattern) return String;
      ...
      type Internal_Entity_Pattern_Detail_List is record

               Node : aliased Bare_Pattern_Detail_List;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Pattern_Detail_List : constant Internal_Entity_Pattern_Detail_List;
      ...
      function Trace_Image (R : Internal_Entity_Pattern_Detail_List) return String;
      ...
      type Internal_Entity_Pattern_List is record

               Node : aliased Bare_Pattern_List;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Pattern_List : constant Internal_Entity_Pattern_List;
      ...
      function Trace_Image (R : Internal_Entity_Pattern_List) return String;
      ...
      type Internal_Entity_Property_Pattern_Detail is record

               Node : aliased Bare_Property_Pattern_Detail;
               --  The stored AST node
      ...
      function Trace_Image (R : Internal_Entity_Property_Pattern_Detail) return String;
      ...
      type Internal_Entity_Renaming_Complex_Pattern is record

               Node : aliased Bare_Renaming_Complex_Pattern;
               --  The stored AST node
        ...
        with Convention => C;
      No_Entity_Renaming_Complex_Pattern : constant Internal_Entity_Renaming_Complex_Pattern;
      ...
      function Trace_Image (R : Internal_Entity_Renaming_Complex_Pattern) return String;
...
Lkt_Complex_Pattern => 4, 
Lkt_Renaming_Complex_Pattern => 4, 
Lkt_Ellipsis_Pattern => 1, 
...
Lkt_Var_Bind => 2);
   ...
   type Root_Node_Record (Kind : Lkt_Node_Kind_Type) is record
      ...
      --  if parsing for all children was successful.
            ...
            Pattern_Match_Branch_F_Pattern : aliased Bare_Pattern :=
               No_Bare_Lkt_Node;
            ...
            Block_Expr_Clause_F_Clause : aliased Bare_Lkt_Node :=
               No_Bare_Lkt_Node;
            ...
            Block_Expr_F_Clauses : aliased Bare_Lkt_Node_List :=
               No_Bare_Lkt_Node;
            ...
            Isa_F_Expr : aliased Bare_Expr :=
               No_Bare_Lkt_Node;
            Isa_F_Pattern : aliased Bare_Pattern :=
               No_Bare_Lkt_Node;
            ...
            null;
                  ...
                  when Lkt_Imported_Name_List_Range =>
            ...
            case Kind is
                  when Lkt_Any_Type_Pattern_Range =>
            ...
            Complex_Pattern_F_Pattern : aliased Bare_Pattern :=
               No_Bare_Lkt_Node;
            Complex_Pattern_F_Details : aliased Bare_Pattern_Detail_List :=
               No_Bare_Lkt_Node;
            Complex_Pattern_F_Predicate : aliased Bare_Expr :=
               No_Bare_Lkt_Node;
            ...
            case Kind is
                  when Lkt_Renaming_Complex_Pattern_Range =>
            ...
            List_Pattern_F_Sub_Patterns : aliased Bare_Pattern_List :=
               No_Bare_Lkt_Node;
            ...
            Or_Pattern_F_Left_Sub_Pattern : aliased Bare_Scoped_Pattern :=
               No_Bare_Lkt_Node;
            Or_Pattern_F_Right_Sub_Pattern : aliased Bare_Scoped_Pattern :=
               No_Bare_Lkt_Node;
            ...
            Paren_Pattern_F_Sub_Pattern : aliased Bare_Pattern :=
               No_Bare_Lkt_Node;
            ...
            Scoped_Pattern_F_Sub_Pattern : aliased Bare_Pattern :=
               No_Bare_Lkt_Node;
            ...
            Field_Pattern_Detail_F_Id : aliased Bare_Id :=
               No_Bare_Lkt_Node;
            Field_Pattern_Detail_F_Expected_Value : aliased Bare_Pattern :=
               No_Bare_Lkt_Node;
