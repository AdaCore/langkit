...
generic
   ...
   with package Iterators is new Liblktlang_Support.Iterators
     (Node_Type, Node_Array);

package Liblktlang_Support.Tree_Traversal_Iterator is
...
private
   ...
   package Natural_Vectors is new Liblktlang_Support.Vectors (Natural);
...
end Liblktlang_Support.Tree_Traversal_Iterator;
